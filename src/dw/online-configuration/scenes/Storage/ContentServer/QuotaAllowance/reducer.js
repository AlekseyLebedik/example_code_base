...
export const reducer = (state = INITIAL_STATE, action) => {
  switch (action.type) {
    case AT.STORAGE_QUOTA_ALLOWANCE_FETCH_SUCCESS: {
    ...
    case AT.STORAGE_QUOTA_ALLOWANCE_LIST_ITEM_ONCLICK:
      return {
        ...state,
        selectedListItem: action.listItem,
      };
    case AT.STORAGE_QUOTA_ALLOWANCE_ADD_MODAL_OPEN:
      return {
        ...state,
        addModalVisible: true,
      };
    case AT.STORAGE_QUOTA_ALLOWANCE_ADD_MODAL_CLOSE:
      return {
        ...state,
        addModalVisible: false,
      };
    case AT.STORAGE_QUOTA_ALLOWANCE_ADD_SUCCESS: {
