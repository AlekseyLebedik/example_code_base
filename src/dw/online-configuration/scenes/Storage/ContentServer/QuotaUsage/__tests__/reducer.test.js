...
describe('QuotaUsage', () => {
  describe('Reducer', () => {
    ...
    describe('STORAGE_QUOTA_USAGE_FETCH_SUCCESS', () => {
    ...
    describe('STORAGE_QUOTA_USAGE_LIST_ITEM_ONCLICK', () => {
    ...
    describe('STORAGE_QUOTA_USAGE_ADD_MODAL_OPEN', () => {
    ...
    describe('STORAGE_QUOTA_USAGE_ADD_MODAL_CLOSE', () => {
    ...
    describe('STORAGE_QUOTA_USAGE_ADD_SUCCESS', () => {
