...
const data = [
  {
    failures: '25',
    userId: '325893307209709294',
    monitoredGroupName: '(unmonitored)',
    unexpected: '20',
    monitoredGroupId: 0,
    percentCorrect: '2',
    userName: 'SHG-MBolak',
...
describe('Security - Anticheat - AnticheatStatistics - StatisticsByUser', () => {
    ...
    it('validate anticheatStatisticsSelector', () => {
      const state = {
        Scenes: {
          Security: {
            Anticheat: {
              AnticheatStatistics: { ByUser: { anticheatStatistics: data } },
            },
          },
        },
      };
